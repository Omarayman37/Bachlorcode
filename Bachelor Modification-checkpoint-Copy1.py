...
def model_emb_cnn(num_classes, raw_dim, n_subclusters):
    ...
    x = LogMelSpectrogram(16000, 1024, 256, 32, f_max=8000)(x)
    ...
    x = tf.keras.layers.Masking(mask_value=1.,
                                  input_shape=(32, 10))(x)
    ...
    # Freq masking
    #x = tfio.audio.time_mask(x, param=10)
...
categories = os.listdir(r"C:\Users\Omar\Documents\Bachelor 2\Dcse2022 dataset/dev_data")
...
if os.path.isfile(str(target_sr) + '_train_raw.npy'):
    ...
    train_atts = []
    train_domains = []
    dicts = [r'C:\Users\Omar\Documents\Bachelor 2\Dcse2022 dataset/dev_data/', r'C:\Users\Omar\Documents\Bachelor 2\Dcse2022 dataset/eval_data/']
    eps = 1e-12
...
if os.path.isfile(str(target_sr) + '_eval_raw.npy'):
    ...
    for label, category in enumerate(categories):
        print(category)
        for count, file in tqdm(enumerate(os.listdir(r"C:\Users\Omar\Documents\Bachelor 2\Dcse2022 dataset/dev_data/" + category + "/test")),
                                total=len(os.listdir(r"C:\Users\Omar\Documents\Bachelor 2\Dcse2022 dataset/dev_data/" + category + "/test"))):
            file_path = r"C:\Users\Omar\Documents\Bachelor 2\Dcse2022 dataset/dev_data/" + category + "/test/" + file
            wav, fs = sf.read(file_path)
            raw = librosa.core.to_mono(wav.transpose()).transpose()[:10 * target_sr]
            eval_raw.append(raw)
...
if os.path.isfile(str(target_sr) + '_test_raw.npy'):
    ...
    for label, category in enumerate(categories):
        print(category)
        for count, file in tqdm(enumerate(os.listdir(r"C:\Users\Omar\Documents\Bachelor 2\Dcse2022 dataset/eval_data/" + category + "/test")),
                                total=len(os.listdir(r"C:\Users\Omar\Documents\Bachelor 2\Dcse2022 dataset/eval_data/" + category + "/test"))):
            file_path = r"C:\Users\Omar\Documents\Bachelor 2\Dcse2022 dataset/eval_data/" + category + "/test/" + file
            wav, fs = sf.read(file_path)
            raw = librosa.core.to_mono(wav.transpose()).transpose()[:10 * target_sr]
            test_raw.append(raw)
...
for k_ensemble in np.arange(1):
    ...
    #data_input = freq_mask(data_input,param = 10)
